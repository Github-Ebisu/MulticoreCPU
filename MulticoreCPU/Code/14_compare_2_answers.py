python_anwer_file = open("../MulticoreCPU/Code/6_multiply_answer.txt", "r")
fpga_answer_file = open("../MulticoreCPU/Code/13_answer_matrix_from_processor.txt", "r")
    ...
    for y in range(dim_c):
        if python_anwer_matrix[x][y] != fpga_answer_matrix[x][y]:
            print(
                ...
                y,
                "] fpga value = ",
                fpga_answer_matrix[x][y],
                " python value = ",
                python_anwer_matrix[x][y],
            )
            not_similar = 1
